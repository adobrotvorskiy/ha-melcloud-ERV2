...
from pymelcloud_erv import DEVICE_TYPE_ATA, DEVICE_TYPE_ATW, DEVICE_TYPE_ERV
...
ERV_SENSORS: tuple[MelcloudSensorEntityDescription, ...] = (
    ...
    MelcloudSensorEntityDescription(
        key="actual_exhaust_fan_speed",
        name="Exhaust fan speed",
        icon="mdi:fan-chevron-down",
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda x: x.device.actual_exhaust_fan_speed,
        enabled=lambda x: True,
        entity_registry_enabled_default=True,
    ),
)
